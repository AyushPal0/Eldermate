      ...
      <section className="w-full max-w-md mx-auto bg-white/80 backdrop-blur-lg rounded-3xl shadow-2xl px-10 py-12 flex flex-col items-center relative animate-fade-in">
        ...
        <form onSubmit={handleSubmit} className="w-full space-y-5 mt-2">
          ...
          <button
            ...
            className={`w-full py-3 rounded-lg transition text-white font-semibold text-lg shadow-md focus:outline-none focus:ring-2 focus:ring-blue-300 active:scale-[.98] ${
              isSubmitting 
                ? 'bg-blue-400 cursor-wait' 
                : 'bg-gradient-to-r from-blue-500 via-blue-400 to-blue-700 hover:from-blue-700 hover:to-blue-500 cursor-pointer'
            }`}
